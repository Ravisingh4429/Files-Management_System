        ...
        <div class="row sidemain">
            <div class="col-md-2 side">
                <ul>
                    ...
                    <li><a href="./fetch.php"> <i class="fa-solid fa-briefcase fa-xl" style="color: #000000;"></i>Class Notification</a></li>
                ...
                <div class="table-responsive py-1">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $str = "select * from emp_announce where course_id='$c_id'";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="C:/xampp/htdocs/php_and_mysql/student management/anoc_image/<?php echo $row["img"] ?>" alt="image" width="50px"></td>
