...
<body>
  <div class="container-fluid">
    ...
    <div class="row sidemain">
      ...
      <div class="row">
                    <div class="col-md-4 cpas pt-2 m-3 pb-4">
                        <h2>Total Query Asked</h2><br>
                        <?php
                          $conn=mysqli_connect("localhost","root","","mini");
                          $str="select count(que),stuid from query where stuid='$sid'";
                    ...
                    <div class="col-md-4 cpas pt-2 m-3 pb-4">
                        <h2>Total present day's</h2><br>
                        <?php
                          $conn=mysqli_connect("localhost","root","","mini");
                          $str="select count(status),stu_id from bba_stuatt where stu_id='$sid'";
                          $res=mysqli_query($conn,$str);
                          $data="";
                          while ($row=mysqli_fetch_assoc($res)) {
